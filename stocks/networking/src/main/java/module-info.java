module networking {
    ...
    exports nl.rug.aoop.networking.Client to messagequeue, stock.exchange;
    exports nl.rug.aoop.networking.MessageHandling to messagequeue, stock.exchange;
    exports nl.rug.aoop.networking.Server to messagequeue, stock.exchange;
}